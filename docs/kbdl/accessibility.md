...
> **KBDL Design Language v1 — active guidance.** KBDL provides accessibility design requirements and implementation guidance; conformance must be verified in each product implementation. Per-requirement
