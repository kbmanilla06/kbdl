...
OUT=ROOT/'docs/kbdl/evidence/kbdl-011-r8/precommit-transcript.txt'
commands=[
 ...
 'git show --no-patch --format=fuller 62f64f040b98de9b2007d4ca2ba326033bb010e5',
 ...
 'python3 docs/kbdl/evidence/kbdl-011-r8/scripts/validate_effective_traceability.py',
