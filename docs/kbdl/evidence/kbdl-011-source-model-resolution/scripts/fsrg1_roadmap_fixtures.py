...
Deterministically proves that `fsrg1_roadmap.compute()`'s FR1-FR6 checks
...
Eleven scenarios:
   ...
   8. FSRG1 promoted out of LOCKED in the unlock map        -> FR5 rejects
   9. downstream KBDL-011-SMR2-VC-0001 entry removed        -> FR5 rejects
  10. prompt declares FSRG1 authorized                      -> FR6 rejects
  11. the real, unmutated roadmap state                     -> PASS (control)
...
FIXTURES = [
    ...
    ("8_fsrg1_promoted_out_of_locked", "rejection", fx_fsrg1_unlocked, {"FR5"}),
    ...
    ("11_real_roadmap_state", "positive", fx_unmutated,
     {"FR1", "FR2", "FR3", "FR4", "FR5", "FR6"}),
    ("12_benign_historical_note", "positive", fx_benign_historical_note,
     {"FR1", "FR2", "FR3", "FR4", "FR5", "FR6"}),
]
